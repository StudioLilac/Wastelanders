...
public class Epilogue3Driving
{
    public DialogueAsCode PartA => new DialogueAsCode()
        ...
        .Line(DialogueCharacter.Jackie,
            "Ugh, what the hell's gotten into the road all of a sudden. It's as if it's been chewed up and spat out.",
        ...
        .Line(DialogueCharacter.Cam,
            "Ives, the other vehicles have automated systems, shouldn't we just put it on auto-pilot?")
        .Line(DialogueCharacter.Ives,
            "Nah, we're up in front precisely so the rest of the convoy have it that easy.")
        .Line(DialogueCharacter.Ives,
            "Our job is to get a feel for the ground beneath us and relay it back.")
        .Line(DialogueCharacter.Ives,
            "You put it on auto-pilot, and the machine assumes the road is paved too.")
        .Line(DialogueCharacter.Ives,
            "I need to feel the wheel kick in my hands so I know which way to steer out of a slide.")
