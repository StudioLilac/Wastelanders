...
namespace Dialogue.Epilogue
{
    ...
    public static class Epilogue_6_Dialogue
    {
        ...
        public static DialogueAsCode Dialogue => new DialogueAsCode()
            ...
            .Line(DialogueCharacter.Jackie, "Yeah, yeah. Whatever.", DialogueSprite.JackieSmile)
            ...
            .Line(DialogueCharacter.Jackie, "Then it happens. Look. I didn’t pick up the phone to be lectured. What do you want?")
