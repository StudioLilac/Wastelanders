...
namespace Dialogue.Epilogue
{
    ...
    public static class Epilogue_6_Dialogue
    {
        ...
        public static DialogueAsCode JackieIvesOpenerTraining => new DialogueAsCode()
            ...
            .Line(DialogueCharacter.Ives, "Not bad kid, but here’s a tip. Right now, you’re faster than you are strong, so use that speed to your advantage.")
        ...
        public static DialogueAsCode Dialogue => new DialogueAsCode()
            ...
            .Line(DialogueCharacter.Cam, "Jackie, you can't just...  These mountains are a signal dead zone!", DialogueSprite.CamTalk)
            .Line(DialogueCharacter.Cam, "I swear, what part of \"danger\" don't you get?", DialogueSprite.CamTalk)
            ...
            .Line(DialogueCharacter.Jackie, "Yeah, yeah. I get it. Ever since what happened to Ives?", DialogueSprite.JackieSulk)
            .Line(DialogueCharacter.Cam, "Right... I wanted to talk to you about her actually.", DialogueSprite.CamTalk)
