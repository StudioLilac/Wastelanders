...
public class Epilogue_9 : MonoBehaviour
{
    ...
    public static class Epilogue9Dialogue
    {
        public static DialogueAsCode RockyJackieDiscussion => new DialogueAsCode()
            ...
            .Line(DialogueCharacter.Rocky, "Don't be ridiculous. You can hardly walk.", DialogueSprite.RockyFocus)
            ...
            .Line(DialogueCharacter.Rocky, "You want to know why?")
            .Line(DialogueCharacter.Rocky, "Because you’re exactly like <i>her</i>.", DialogueSprite.RockyFocus)
            ...
            .Line(DialogueCharacter.Rocky, "To prove that, perhaps <i>she</i>— could be the one thing in the world you <i>could</i> count on.", DialogueSprite.RockyFocus)
            ...
            .Line(DialogueCharacter.Jackie, "How she'd sugarcoat her missions by calling them ‘business trips’?", DialogueSprite.JackieRetort)
            .Line(DialogueCharacter.Jackie, "How she'd promise to be back soon when there was no way of knowing?", DialogueSprite.JackieSerious)
            .Line(DialogueCharacter.Jackie, "How if she really truly wanted to be someone who could be counted on, m-maybe she should have just stayed the fuck home?", DialogueSprite.JackieHurt) 
            .Line(DialogueCharacter.Rocky, "...", DialogueSprite.RockyFocus)
            .Line(DialogueCharacter.Jackie, "...")
            .Line(DialogueCharacter.Jackie, "I’m not my Ma, Rocky.", DialogueSprite.JackieDowncast)
            ...
            .Line(DialogueCharacter.Jackie, "I don’t know if we’ll find the frog. I don’t know if your scouts are still alive.", DialogueSprite.JackieContemplative)
            ...
            .Line(DialogueCharacter.Jackie, "Kade didn’t ask when she saved my life.", DialogueSprite.JackieDowncast)
            .Line(DialogueCharacter.Jackie, "But I’m asking.", DialogueSprite.JackieContemplative)
            ...
            .Line(DialogueCharacter.Rocky, "...Fine.", DialogueSprite.RockyFocus)
            .Line(DialogueCharacter.Rocky, "But you stay in the center formation and navigate with Kade. Jay, you're on point with me.")
            .Line(DialogueCharacter.Rocky, "If I say retreat, we retreat. No heroics. Capiche?", DialogueSprite.RockySerious)
            .Line(DialogueCharacter.Jackie, "Capiche.", DialogueSprite.JackieWry)
