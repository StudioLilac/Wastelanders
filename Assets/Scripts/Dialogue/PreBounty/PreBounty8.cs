...
namespace Dialogue.PreBounty
{
    ...
    public static class PreBounty8Dialogue
    {
        ...
        public static DialogueAsCode Opening => new DialogueAsCode()
            ...
            .Enter(DialogueCharacter.Rocky, CharacterActions.SetLeft, DialogueSprite.RockyFocus).Enter(DialogueCharacter.Kade, CharacterActions.SetOffscreenRight, DialogueSprite.KadeSoft, fadeDuration: 0f)
            .Move(DialogueCharacter.Rocky, CharacterActions.FaceLeft)
            ...
            .Line(DialogueCharacter.Rocky, "Knew her? We were her team.", DialogueSprite.RockySerious)
            ...
            .Line(DialogueCharacter.Rocky, "We were betrayed, and we... lost her.", DialogueSprite.RockyFocus)
            ...
            .InterruptedLine(DialogueCharacter.Jackie, "Betrayed? By who? Tell me! I have to—", DialogueSprite.JackieSurprisedOpen, duration: 3)
            .Line(DialogueCharacter.Rocky, "No. Absolutely not. Look at you. You can't even walk and are already looking for another fight.", DialogueSprite.RockySerious)
        ...
        public static DialogueAsCode AfterRecovery => new DialogueAsCode().Enter(DialogueCharacter.Rocky, CharacterActions.SetLeft).Enter(DialogueCharacter.Jay, CharacterActions.SetOffscreenRight, DialogueSprite.JaySorry, fadeDuration: 0f)
            ...
            .Line(DialogueCharacter.Jackie, "Do I... know you?")
            .Line(DialogueCharacter.Jay, "It’s me! Uncle Jay! Wow. You’ve grown so much! I haven’t seen you since you were, well, little!")
            .Line(DialogueCharacter.Rocky, "Jay’s got a perfect memory. Doesn’t forget a face. Or anything, for that matter.")
            ...
            .Line(DialogueCharacter.Jackie, "Is... is he okay?")
    ...
    public static DialogueAsCode FlashBackDone => new DialogueAsCode()
            ...
            .Line(DialogueCharacter.Jackie, "...Can I ask a question?")
            ...
            .Line(DialogueCharacter.Jackie, "...But that’s so messed up. I feel...")
        ...
        public static DialogueAsCode AilinScan => new DialogueAsCode()
            ...
            .Line(DialogueCharacter.Cam, "Thank goodness... Now I won’t have to search using myself. Afterall, Ives doesn’t have time to waste—", DialogueSprite.CamSmile)
            .Line(DialogueCharacter.Cam, "On second thought, I should have rephrased that...", DialogueSprite.CamNeutral)
