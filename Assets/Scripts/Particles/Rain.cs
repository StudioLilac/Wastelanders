...
namespace Particles {
    ...
    public class Rain : MonoBehaviour {
        [Header("Rain Settings")] [Tooltip("Number of rain particles emitted per second")] [SerializeField]
        private float emissionRate = 100f;

        [Tooltip("Lifetime of each rain drop in seconds")] [SerializeField]
        ...
        [Tooltip("Color of the rain")] [SerializeField]
        private Color rainColor = new Color(0.7f, 0.8f, 1f, 0.5f);

        [Header("Wind Settings")] [Tooltip("Horizontal wind force affecting rain angle")] [SerializeField]
