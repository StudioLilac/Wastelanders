...
public class ActorDatabase : ScriptableObject
{
    ...
    public ActorProfile Cam;
    public ActorProfile Weise;
    public ActorProfile Ailin;
    public ActorProfile Rocky;
    public ActorProfile Kade;
    public ActorProfile Jay;
    public ActorProfile Ari;
    public ActorProfile Nites;
    public ActorProfile System;
