...
public abstract class SceneData : Enum<SceneData>
{
    ...
    public class TutorialFight : SceneData
    {
        ...
        public override MonoBehaviour[] RequiredPrefabs(SceneInitializerPrefabs prefabs) => new MonoBehaviour[]
            { prefabs.audioManager, prefabs.uiFadeScreenManager, prefabs.combatFadeScreenManager, prefabs.pauseMenuV2, prefabs.hudV2, prefabs.arrowIndicatorManager, prefabs.dialogueManager, prefabs.popupManager,  prefabs.gameOver, prefabs.battleIntro, prefabs.dialogueBoxV2 };
    }
    ...
    public class PreQueenFight : SceneData
    {
        ...
        public override MonoBehaviour[] RequiredPrefabs(SceneInitializerPrefabs prefabs) => new MonoBehaviour[]
            { prefabs.audioManager, prefabs.uiFadeScreenManager, prefabs.combatFadeScreenManager, prefabs.pauseMenuV2, prefabs.hudV2, prefabs.arrowIndicatorManager, prefabs.dialogueManager, prefabs.popupManager,  prefabs.gameOver, prefabs.battleIntro  };
    }
    ...
    public class PostQueenFight : SceneData
    {
        ...
        public override MonoBehaviour[] RequiredPrefabs(SceneInitializerPrefabs prefabs) => new MonoBehaviour[]
            { prefabs.audioManager, prefabs.uiFadeScreenManager, prefabs.combatFadeScreenManager, prefabs.pauseMenuV2, prefabs.hudV2, prefabs.arrowIndicatorManager, prefabs.dialogueManager, prefabs.combatFadeScreenManager };
    }
