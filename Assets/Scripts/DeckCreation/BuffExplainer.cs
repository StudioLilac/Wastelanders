...
#nullable enable
    ...
    public class WeaponExplanation
    {
        ...
        public static readonly WeaponExplanation STAFF_EXPLANATION = new(weaponType: WeaponType.STAFF, explanationTitle: "FLOW", explanationText: "The next Action's Power gains +1 to its upper and lower bound for every stack of Flow. Then consume all Flow.");
        public static readonly WeaponExplanation PISTOL_EXPLANATION = new(weaponType: WeaponType.PISTOL, explanationTitle: "ACCURACY", explanationText: "Lower bound of an Action's Power increases by 1 per stack. On taking damage, stacks are halved (rounded down).");
        public static readonly WeaponExplanation AXE_EXPLANATION = new(weaponType: WeaponType.AXE, explanationTitle: "WOUND", explanationText: "Damage taken by an Action increases by 1 per stack. Stacks are halved after each round (rounded down).");
        ...
        public static readonly WeaponExplanation RESONATE_EXPLANATION = new(weaponType: WeaponType.ENEMY, explanationTitle: "RESONANCE", explanationText: "Upper bound of an Action's power increases by 1 per stack.");
