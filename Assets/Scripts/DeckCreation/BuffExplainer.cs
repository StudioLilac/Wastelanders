...
#nullable enable
    ...
    public class WeaponExplanation
    {
        ...
        public static readonly WeaponExplanation RESONATE_EXPLANATION = new(weaponType: WeaponType.ENEMY, explanationTitle: "RESONATE", explanationText: "Upper bound of an Action's power increases by 1 per stack.");
